    ...
    <div class="cen">
        <table>
            <tr>
                ...
                <th class="in">Option</th>
            </tr>
            <c:forEach items ="${users}" var="user">
                <tr>
                    <td class="id"> ${user.id}</td>
                    <td class="in"> ${user.name}</td>
                    <td class="in"> ${user.email}</td>
                    <td class="in"> ${user.phoneNumber}</td>
                    <th class="in">
                        <a href="http://localhost:8080/ShoeShop/user/ViewUser.jsp?id=${user.id}"><button>Detail</button></a> 
                    </th>
                </tr>
            </c:forEach>
        </table>
