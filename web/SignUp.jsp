...
<!--                <div class="product">
      ...
      <!-- end-menu -->
        ...
        <form name="register" action="SendMail.jsp" method="post">
            <label class="lab">Tài khoản </span</label><br> <input name="username" type="text" placeholder="example"> <br> <br>
            <label class="lab">Mật khẩu</label><br> <input name="password" type="password" placeholder="********"> <br> <br>
            <label class="lab">Họ và tên </label><br> <input name="name" type="text" placeholder="Nguyễn Văn A"> <br> <br>
            <label class="lab">Email </label><br> <input name="email" type="text" placeholder="nguyenvana@gmal.com"> <br> <br>
            <label class="lab">Số điện thoại</label><br> <input name="phone_number" type="number" placeholder="0912345678"> <br> <br>
            <label class="lab">Địa chỉ </label><br> <input name="address" type="text" placeholder="ha noi"> <br> <br>
            <div class="_58mq _5dbb" id="birthday_wrapper"><span class="mtm mbs _2_68 _7-1r"><label>Ngày sinh</label></span>
            <div class="_5k_5"><span class="_5k_4" data-type="selectors" data-name="birthday_wrapper" id="u_0_x"><span>
            ...
            <br><br
            <label class="lab"</label> <input name="gender" type="radio" value="male"> Nam 
            <label class="lab"></label> <input name="gender" type="radio" value="female"> Nữ 
            <br><br>
            <input type="submit" value="Đăng k"ý>
        </form>
        <!-- end register-->
