<%-- 
    ...
    Created on : Nov 24, 2019, 4:48:51 PM
    Author     : hiepnguyen
--%>
...
<!--                <div class="product">
      ...
      <!-- end-menu -->
        <%
            List<User> customers = new UserService().getAllInforCustomer();
    ...
    <div class="cen">
        <table>
            ...
            <tr>
                <td class="id">${cu.id}</td>
                <td class="in">${cu.name}</td>
                <td class="in">${cu.email}</td>
                <td class="in">${cu.phoneNumber}</td>
                <td>
                    <a href="ViewUser.jsp?id=${cu.id}"><button>Detail</button></a> 
                </td>
            </tr>
            </c:forEach>
        </table>
